    ...
    <div className="space-y-8 max-w-[1200px] mx-auto relative">
      ...
      <div className="flex items-center justify-center mb-10">
        <div className="flex items-center w-full max-w-2xl">
          ...
          {/* Step 2: Pagamento */}
          <div className="flex flex-col items-center">
            <div className={`w-12 h-12 rounded-full flex items-center justify-center mb-2 font-bold transition-all ${
              step >= 2 
          ...
          <div className={`flex flex-col items-center ${step < 3 ? "opacity-45" : ""}`}>
            <div className={`w-10 h-10 rounded-full border-2 flex items-center justify-center mb-2 font-bold text-xs ${
              step >= 3 
      ...
      {step === 2 ? (
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          {/* Left Column: Input methods & instructions */}
          <div className="lg:col-span-8 space-y-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              {/* Submit trigger button handles right widget checkout */}
            </form>
          </div>

          {/* Right Column: Order summary & Submit trigger */}
